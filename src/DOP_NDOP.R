...
for(pval in pval){
  ...
  dir.create(paste0("./output/Dop_Ndop/pval_",pval,"/day/"),recursive = TRUE)
  outdir <- paste0("./output/Dop_Ndop/pval_",pval,"/day/")
  dir.create(paste0("./output/Dop_Ndop/pval_",pval,"/Table"),recursive = TRUE)
  outdirT<-paste0("./output/Dop_Ndop/pval_",pval,"/Table/")
  ...
  dir.create(paste0("./output/Dop_Ndop/pval_",pval,"/Cell/"),recursive = TRUE)
  outdir <- paste0("./output/Dop_Ndop/pval_",pval,"/Cell/")
  ...
  dir.create(paste0("./output/Dop_Ndop/pval_",pval,"/day_cell/"),recursive = TRUE)
  outdir <- paste0("./output/Dop_Ndop/pval_",pval,"/day_cell/")
