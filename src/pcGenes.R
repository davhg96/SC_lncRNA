...
dataclean <- subset(data[,7:48]) #take the sample columns
...
coldata <- data.frame(FGF=factor(c(rep("FGF8_minus",21),rep("FGF8_plus",21))),
                      ...
                      cell_type=factor(rep(c("DA.1","DA.2","DA.E1","FP.cycling","FP.early","FP.late","VLMC"),6)))
...
for(pval in pval){
  ...
  dir.create(paste0("./output/pcGenes/pval_",pval,"/day/"),recursive = TRUE)
  outdir <- paste0("./output/pcGenes/pval_",pval,"/day/")
  dir.create(paste0("./output/pcGenes/pval_",pval,"/Table"),recursive = TRUE)
  outdirT<-paste0("./output/pcGenes/pval_",pval,"/Table/")
  ...
  dir.create(paste0("./output/pcGenes/pval_",pval,"/Cell/"),recursive = TRUE)
  outdir <- paste0("./output/pcGenes/pval_",pval,"/Cell/")
  ...
  dir.create(paste0("./output/pcGenes/pval_",pval,"/day_cell/"),recursive = TRUE)
  outdir <- paste0("./output/pcGenes/pval_",pval,"/day_cell/")
